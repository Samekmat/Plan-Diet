...
class RegistrationForm(forms.Form):
    ...
    first_name = forms.CharField(
        label="First_name", required=False, widget=forms.TextInput(attrs={"class": "form-control"})
    )
    last_name = forms.CharField(
        label="Last_name", required=False, widget=forms.TextInput(attrs={"class": "form-control"})
    )
    ...
    height = forms.IntegerField(
        label="Height", required=False, widget=forms.NumberInput(attrs={"class": "form-control"})
    )
    weight = forms.FloatField(label="Weight", required=False, widget=forms.NumberInput(attrs={"class": "form-control"}))
    sex = forms.ChoiceField(
        label="Sex", choices=SEX, required=False, widget=forms.Select(attrs={"class": "form-control"})
    )
